...
class Command(BaseCommand):
    ...
    def create_sample_products(self):
        ...
        hybrid_bikes = Category.objects.get(name='hybrid_bikes')
        ...
        products_data = [
            ...
            {
                'category': hybrid_bikes,
                'sku': 'HB001',
                'name': 'Trek FX 3 Disc',
                'description': 'The Trek FX 3 Disc is a versatile hybrid bike that\'s perfect for fitness rides and commuting.',
                'price': 749.99,
                'rating': 4.5,
                'stock_quantity': 11,
                'frame_size': '17.5"',
                'wheel_size': '700c',
                'gear_system': 'Shimano Acera 24-speed',
            },
            {
            ...
            },
            {
                ...
                'description': 'Professional cycling jersey made from moisture-wicking fabric.',
                'price': 79.99,
                'rating': 4.4,
                'stock_quantity': 30,
                'has_sizes': True,
